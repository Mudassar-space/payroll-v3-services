...
class LocationRequestPayload(CamelModel):
    location_name: constr(min_length=1, max_length=50)
    notes: Optional[constr(min_length=1, max_length=100)]




class LocationResponsePayload(LocationRequestPayload,WhoCreateDataModel,WhoUpdateDataModel):
...
class LocationListModel(CamelModel):
...
class LocationListResponseModel(CamelModel):
    page: Optional[int]
    size: Optional[int]
    total: Optional[int]
    items: Optional[List[LocationListModel]]
