...
class StatesRequestPayload(Country):
    country: Optional[str]




class StatesResponsePayload(StatesRequestPayload):
    id: Optional[PyObjectId] = Field(default_factory=PyObjectId)


class StatesUpdateResponse(StatesRequestPayload):
    id: Optional[PyObjectId] = Field(default_factory=PyObjectId)
...
class StatesListResponse(CamelModel):
    page: Optional[int]
    size: Optional[int]
    total: Optional[int]
    items: Optional[List[StatesResponsePayload]]
...
class StatesDdlResponsePayload(CamelModel):
    short_code: Optional[str]
    value: Optional[str]
    label: Optional[str]

class StatesDdlListResponse(CamelModel):
    page: Optional[int]
    size: Optional[int]
    total: Optional[int]
    items: Optional[List[StatesDdlResponsePayload]]
